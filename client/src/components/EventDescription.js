    ...
    <div className="card event-description" key={event.id} id={event.id}>
      <div className="top-event-description">
        <div className="d-flex">
          <card className="back-icon-container" onClick={goBack}><i role="navigation" className="fas fa-arrow-left back-icon" /></card>
        ...
        <card role="banner" className="card m-3 justify-content-between align-items-center d-flex flex-row add-to-schedule" onClick={goBack}>
